layui.define(['layer', 'element'], function (exports) {
    ...
    // 输出
    exports('data_table', mod);
});


// 表格选中
$(document).on('click', '#dateTable tbody tr input[type="checkbox"]', function () {
...
// 全选和反选
$(document).on('click', '#dateTable thead tr input[type="checkbox"]', function () {
